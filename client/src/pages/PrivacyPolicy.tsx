  ...
  return <main dir="rtl" className="privacy-page">
    ...
    <section className="privacy-hero">
      <div className="page-width">
        ...
        <p>في أثر، نبدأ بأقل قدر ممكن من المعلومات ونشرح لك كل خطوة قبل أن نطلبها. هذه السياسة توضح ببساطة ما الذي نحفظه، وما الذي لا نطلبه في الموقع، وكيف يمكنك التحكم في بياناتك.</p>
