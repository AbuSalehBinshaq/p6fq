...
const navItems = [
  { href: "/admin/summary", label: "ملخص الشهر", icon: BarChart3 }, { href: "/admin/orders", label: "الطلبات", icon: ClipboardList }, { href: "/admin/expenses", label: "المصاريف", icon: ReceiptText }, { href: "/admin/marketing", label: "المسوقون والعمولات", icon: Megaphone }, { href: "/admin/partners", label: "الشركاء السابقون", icon: Megaphone }, { href: "/admin/settings", label: "الإعدادات", icon: Settings },
];
