...
export async function updateRenderOrderReferral(reference: string, referralCode: string | null) { await getRenderPool().query("UPDATE conversation_orders SET referral_code = $2, updated_at = NOW() WHERE reference = $1", [reference, referralCode]); }
